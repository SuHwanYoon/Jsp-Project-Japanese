...
function check(f){
	...
	<form action="addelete.doo" method="post" name="frm" onSubmit="return check(this)">
	...
	<table border="1">
		...
		<c:choose>
			...
			<input type="submit" value="変更" name="BTN">
		</td></tr>
			</c:when>
			<c:when test="${DATA == 'admin'}">
					<tr><td colspan="2" align="center">
			<input type="submit" value="管理者削除" name="ADD">
		</td></tr>
			</c:when>
			<c:otherwise>
	...
	<input type="hidden" name="ADDELETE" value="${ADMIN }">
	</form>
</section>
</div>
<footer>
